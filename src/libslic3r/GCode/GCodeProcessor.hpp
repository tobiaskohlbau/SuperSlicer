...
namespace Slic3r {
    ...
    private:
        ...
        struct TimeProcessor
        {
            ...
            MachineEnvelopeConfig machine_limits = MachineEnvelopeConfig{};
            ...
            TimeProcessor() {
                machines[static_cast<size_t>(PrintEstimatedStatistics::ETimeMode::Normal)].time_mode = PrintEstimatedStatistics::ETimeMode::Normal;
                machines[static_cast<size_t>(PrintEstimatedStatistics::ETimeMode::Stealth)].time_mode = PrintEstimatedStatistics::ETimeMode::Stealth;
            };
